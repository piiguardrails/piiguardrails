...
1. **Azure Compute VM**: Canonical Ubuntu 24.04 LTS (`Standard_D2s_v3` default, 2 vCPU, 8GB RAM) optimized for ultra-low latency PII masking, NER tokenization, and custom regex profiling.
